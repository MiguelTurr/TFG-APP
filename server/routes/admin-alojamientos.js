...
router.get('/', (req, res) => {
    ...
    mysql.query(
        `SELECT alo.ID,alo.usuarioID,alo.ubicacion,alo.creadoEn,alo.precio,alo.valoracionMedia,alo.vecesValorado,usu.ID as userId,CONCAT(usu.nombre," ",usu.apellidos) AS userNombre FROM alojamientos as alo
