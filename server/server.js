...
const { cookie_secret, dev_state } = require('./services/config.js');
...
server.use('/denunciar', comprobarToken, require('./routes/denunciar'));

server.use('/perfil', comprobarToken, require('./routes/perfil'));
server.use('/perfil/favoritos', comprobarToken, require('./routes/favoritos'));
server.use('/perfil/recomendados', comprobarToken, require('./routes/recomendados'));
server.use('/perfil/notificaciones', comprobarToken, require('./routes/notificaciones'));

//server.use('/perfil/mis-alojamientos', comprobarToken, require('./routes/notificaciones'));
//server.use('/perfil/mis-reservas', comprobarToken, require('./routes/notificaciones'));